...
public class Plat2Search extends HttpServlet{
	...
	String db="jdbc:mysql://localhost/Platinum";
	Connection cn;
	Statement st;
	ResultSet rs;
	...
	rs=st.executeQuery("select *from FoodPackage_Platinum where ContactNo="+con+"");
	while(rs.next()){

...
public class BV extends HttpServlet{
	...
	String db="jdbc:mysql://localhost/BirdView";
	Connection cn;
	Statement st;
	ResultSet rs;
	...
	st.executeUpdate("insert into FoodPackage_BirdView(ContactNo,PackageName,PackagePrice,NoOfDays,NoOfMembers) values('"+con+"','"+pn+"','"+pp+"','"+nd+"','"+nm+"')");
	}

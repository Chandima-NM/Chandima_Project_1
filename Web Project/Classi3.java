...
public class Classi3 extends HttpServlet{
	...
	st.executeUpdate("insert into FoodPackage_Classic(ContactNo,PackageName,PackagePrice,NoOfDays,NoOfMembers) values('"+con+"','"+pn+"','"+pp+"','"+nd+"','"+nm+"')");
	}

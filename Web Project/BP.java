...
public class BP extends HttpServlet{
	...
	String db="jdbc:mysql://localhost/BeachPark";
	Connection cn;
	Statement st;
	ResultSet rs;
	...
	st.executeUpdate("insert into FoodPackage_BeachPark(ContactNo,PackageName,PackagePrice,NoOfDays,NoOfMembers) values('"+con+"','"+pn+"','"+pp+"','"+nd+"','"+nm+"')");
	}
